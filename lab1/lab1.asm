...
ST  R1,OUTPUT                 ; This address contains X\!
    TRAP x25
  
INPUT     .FILL  x0005        ; Input for X\!, in this case X = 5. x300E
ZERO      .FILL  x0000        ; stored @ x300F
NEGONE    .FILL  xFFFF        ; 2's complement of 1 (i.e. \-1). x3010
OUTPUT    .FILL  x0000        ; At program completion, the result is x3011
    ;   stored here
