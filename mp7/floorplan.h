...
// added helper functions listed below
node_t* challengeHelper(node_t* par, int n);           // helper fxn for challenge
void bubbleSortModules(module_t* n);                   // bubblesort the modules
